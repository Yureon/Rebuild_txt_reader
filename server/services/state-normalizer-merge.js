const { ensurePlainObject, sanitizeStringList } = require('./state-normalizer-core');
...
const { sanitizeBookmarkList, sanitizeCollapsedFolders, sanitizeRecentList } = require('./state-normalizer-lists');
...
function mergeSharedStateInput(prevShared = {}, nextShared = {}, options = {}) {
  ...
  const normalizeSyncPolicyInput = typeof options.normalizeSyncPolicyInput === 'function'
    ...
    : (value) => value || {};
  const merged = Object.assign({}, prevShared || {}, nextShared || {});
  ...
  if (ensurePlainObject(nextShared.viewerPrefs)) {
    merged.viewerPrefs = normalizeViewerPrefs(nextShared.viewerPrefs);
  } else {
...
function mergeDeviceStateInput(prevDevice = {}, nextDevice = {}, options = {}) {
  ...
  const merged = Object.assign({}, prevNormalized, nextDevice || {});
