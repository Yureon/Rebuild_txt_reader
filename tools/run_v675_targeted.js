...
const outputPath = path.resolve(root, outputArg ? outputArg.slice('--output='.length) : 'v675_targeted_results.json');
const tests = [
  'tools/checks/release-verify-current-coverage-v675-smoke.js',
...
const payload = {
  schemaVersion:1,
  pass:'v675-targeted-results-pass',
  version:675,
