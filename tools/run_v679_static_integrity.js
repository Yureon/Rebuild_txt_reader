...
const staticOutput = path.join(root, 'v679_full_tree_static_scan.json');
const integrityOutput = path.join(root, 'v679_static_integrity_results.json');
...
const staticPayload = {
  pass:'v679-full-tree-static-pattern-scan-pass',
...
const payload = {
  schemaVersion:1,
  pass:'v679-static-integrity-pass',
  version:679,
  packageVersion:'6.79.0',
  buildId:'rebuild-v679',
  generatedAt:new Date().toISOString(),
  javascriptSyntax:{
    pass:'v679-javascript-syntax-pass',
