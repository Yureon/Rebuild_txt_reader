...
const outputPath = path.resolve(root, outputArg ? outputArg.slice('--output='.length) : 'v681_targeted_results.json');
const tests = [
  'tools/checks/release-verify-current-coverage-v681-smoke.js',
  'tools/checks/v681-active-check-registration-smoke.js',
...
const payload = {
  schemaVersion:1,
  pass:'v681-targeted-results-pass',
  version:681,
