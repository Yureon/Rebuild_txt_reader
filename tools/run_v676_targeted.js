...
const outputPath = path.resolve(root, outputArg ? outputArg.slice('--output='.length) : 'v676_targeted_results.json');
const tests = [
  'tools/checks/release-verify-current-coverage-v676-smoke.js',
  'tools/checks/v676-active-check-registration-smoke.js',
...
const payload = {
  schemaVersion:1,
  pass:'v676-targeted-results-pass',
  version:676,
