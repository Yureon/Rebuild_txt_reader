...
const outputPath = path.resolve(root, outputArg ? outputArg.slice('--output='.length) : 'v677_targeted_results.json');
const tests = [
  'tools/checks/release-verify-current-coverage-v677-smoke.js',
  'tools/checks/v677-active-check-registration-smoke.js',
...
const payload = {
  schemaVersion:1,
  pass:'v677-targeted-results-pass',
  version:677,
