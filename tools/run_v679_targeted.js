...
const outputPath = path.resolve(root, outputArg ? outputArg.slice('--output='.length) : 'v679_targeted_results.json');
const tests = [
  'tools/checks/release-verify-current-coverage-v679-smoke.js',
  'tools/checks/v679-active-check-registration-smoke.js',
...
const payload = {
  schemaVersion:1,
  pass:'v679-targeted-results-pass',
  version:679,
