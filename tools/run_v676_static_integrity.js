...
const staticOutput = path.join(root, 'v676_full_tree_static_scan.json');
const integrityOutput = path.join(root, 'v676_static_integrity_results.json');
...
const staticPayload = {
  pass:'v676-full-tree-static-pattern-scan-pass',
...
const payload = {
  schemaVersion:1,
  pass:'v676-static-integrity-pass',
  version:676,
  packageVersion:'6.76.0',
  buildId:'rebuild-v676',
  generatedAt:new Date().toISOString(),
  javascriptSyntax:{
    pass:'v676-javascript-syntax-pass',
