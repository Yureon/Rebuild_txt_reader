...
const staticOutput = path.join(root, 'v678_full_tree_static_scan.json');
const integrityOutput = path.join(root, 'v678_static_integrity_results.json');
...
const staticPayload = {
  pass:'v678-full-tree-static-pattern-scan-pass',
...
const payload = {
  schemaVersion:1,
  pass:'v678-static-integrity-pass',
  version:678,
  packageVersion:'6.78.0',
  buildId:'rebuild-v678',
  generatedAt:new Date().toISOString(),
  javascriptSyntax:{
    pass:'v678-javascript-syntax-pass',
