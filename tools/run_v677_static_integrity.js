...
const staticOutput = path.join(root, 'v677_full_tree_static_scan.json');
const integrityOutput = path.join(root, 'v677_static_integrity_results.json');
...
const staticPayload = {
  pass:'v677-full-tree-static-pattern-scan-pass',
...
const payload = {
  schemaVersion:1,
  pass:'v677-static-integrity-pass',
  version:677,
  packageVersion:'6.77.0',
  buildId:'rebuild-v677',
  generatedAt:new Date().toISOString(),
  javascriptSyntax:{
    pass:'v677-javascript-syntax-pass',
