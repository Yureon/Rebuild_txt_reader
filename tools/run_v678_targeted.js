...
const outputPath = path.resolve(root, outputArg ? outputArg.slice('--output='.length) : 'v678_targeted_results.json');
const tests = [
  'tools/checks/release-verify-current-coverage-v678-smoke.js',
  'tools/checks/v678-active-check-registration-smoke.js',
...
const payload = {
  schemaVersion:1,
  pass:'v678-targeted-results-pass',
  version:678,
