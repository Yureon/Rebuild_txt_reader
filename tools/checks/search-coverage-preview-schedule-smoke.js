...
assert.ok(matcher.includes("SEARCH_WORKER_SCRIPT_URL = '/scripts/rebuild/features/search/search-worker.js?v=rebuild-v564'"), 'search worker cachebuster must match v534');
