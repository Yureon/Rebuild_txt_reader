...
const required = [
  'release-verify-current-coverage-v662-smoke.js',
  'v662-deferred-ui-530-recovery-smoke.mjs',
  'deferred-ui-fragment-smoke.js',
...
console.log(JSON.stringify({ pass:'v662-release-verify-current-coverage-pass', required:required.length }));
