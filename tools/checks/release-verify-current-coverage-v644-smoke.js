...
const required = [
  'release-verify-current-coverage-v644-smoke.js',
  'library-mobile-header-v644-smoke.js',
  'library-entry-load-budget-v644-smoke.mjs'
];
...
console.log(JSON.stringify({ pass:'v644-release-verify-current-coverage-pass', required:required.length }));
