...
assert(layout.includes('v.pendingScrollTarget = null') && layout.includes('slider manifest block target aligns the target char'), 'direct slider branch must bypass pending row scrollIntoView and preserve the measured-char anchor');
