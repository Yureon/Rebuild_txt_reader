...
assert.ok(source.includes('/login.html') && source.includes('/library.html') && source.includes('/site.html') && source.includes('/mobile.html') && source.includes('/admin/users.html'), 'deployed script must check HTML entry routes');
