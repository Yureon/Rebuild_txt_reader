...
const required = [
  'release-verify-current-coverage-v653-smoke.js',
  'settings-library-tab-visibility-v653-smoke.mjs',
  'library-mobile-header-reveal-v653-smoke.mjs',
  'settings-workspace-v652-smoke.mjs',
  'admin-cleanup-summary-v651-smoke.mjs',
  'reader-jump-percent-input-v652-smoke.mjs'
];
...
console.log(JSON.stringify({ pass:'v653-release-verify-current-coverage-pass', required:required.length }));
