...
async function runAdminOperationalDiagnosticsSmoke(root = path.join(__dirname, '..', '..')) {
...
if (require.main === module) runAdminOperationalDiagnosticsSmoke().then(result => console.log(JSON.stringify(result))).catch(error => { console.error(error); process.exit(1); });
