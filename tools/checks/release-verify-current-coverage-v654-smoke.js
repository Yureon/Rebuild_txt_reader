...
const required = [
  'release-verify-current-coverage-v654-smoke.js',
  'v654-settings-shelf-navigation-smoke.mjs',
...
console.log(JSON.stringify({ pass:'v654-release-verify-current-coverage-pass', required:required.length }));
