...
const required = [
  'release-verify-current-coverage-v647-smoke.js',
  'library-settings-diagnostics-v647-smoke.mjs',
  'reader-search-modal-v647-smoke.js'
];
...
console.log(JSON.stringify({ pass:'v647-release-verify-current-coverage-pass', required:required.length }));
