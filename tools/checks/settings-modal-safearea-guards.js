...
function runSettingsModalSafeareaGuardChecks(ctx) {
  ...
  ['id="settings-panel-body" class="sp-body" data-settings-main-body="tabs" data-settings-tab-panels-owner="general viewer func data debug"','data-settings-panel-level="sp-body-child"','data-settings-tab-body="general"','data-settings-tab-body="data"','data-settings-tab-body="debug"','settings-inline-stepper ui-font-stepper','setting-action-btn--flex','setting-action-btn--full','data-adv-actions--stack','vsp-panel--flush-top','자동 배치 (시계/진행률 겹침 회피)'].forEach((marker) => {
