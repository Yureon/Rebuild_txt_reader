...
assert.ok(progress.includes('fileCharIndex: Number.isFinite(Number(address.fileCharIndex))'), 'snapshot must persist fileCharIndex for diagnostics/resume analysis');
