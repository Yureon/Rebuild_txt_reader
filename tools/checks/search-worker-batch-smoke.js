...
assert.ok(matcher.includes('const SEARCH_WORKER_BATCH_SIZE_MAX = 5'), 'search worker batch max must stay server-friendly while reducing worker postMessage round trips');
