...
function runAdminCloudflareVisitorDiagnosticsSmoke(root = path.join(__dirname, '..', '..')) {
...
if (require.main === module) console.log(JSON.stringify(runAdminCloudflareVisitorDiagnosticsSmoke()));
