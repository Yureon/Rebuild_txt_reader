...
const required = [
  'release-verify-current-coverage-v657-smoke.js',
  'v657-admin-settings-viewport-smoke.mjs',
  'v656-mobile-explorer-settings-smoke.mjs',
  'v655-library-settings-admin-ux-smoke.mjs',
...
console.log(JSON.stringify({ pass:'v657-release-verify-current-coverage-pass', required:required.length }));
