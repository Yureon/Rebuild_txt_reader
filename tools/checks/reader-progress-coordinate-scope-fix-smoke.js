...
assert.ok(body.includes('const sliderProgress = resolveNavSliderProgress(app, address, localRatio);'), 'updateProgressFromViewport must define sliderProgress locally');
