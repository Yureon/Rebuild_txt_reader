...
assert.ok(matcher.includes('SEARCH_WORKER_SCRIPT_URL = \'/scripts/rebuild/features/search/search-worker.js?v=rebuild-v564\''), 'worker cachebuster must match current rebuild');
