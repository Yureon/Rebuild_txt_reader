...
assert.ok(script.includes('npm') && script.includes('install') && script.includes('tools/check_server_structure.js') && script.includes('tools/smoke_server_http.js'), 'with-server command set missing');
