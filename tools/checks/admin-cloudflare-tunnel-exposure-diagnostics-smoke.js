...
function runAdminCloudflareTunnelExposureDiagnosticsSmoke(root = path.join(__dirname, '..', '..')) {
  ...
  const result = diagnosticsService.buildDiagnostics(req);
...
if (require.main === module) console.log(JSON.stringify(runAdminCloudflareTunnelExposureDiagnosticsSmoke()));
