...
const required = [
  'release-verify-current-coverage-v651-smoke.js',
  'admin-cleanup-summary-v651-smoke.mjs',
  'update-banner-critical-v651-smoke.js',
  'settings-page-state-v651-smoke.mjs'
];
...
console.log(JSON.stringify({ pass:'v651-release-verify-current-coverage-pass', required:required.length }));
