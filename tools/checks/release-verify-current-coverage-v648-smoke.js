...
const required = [
  'release-verify-current-coverage-v648-smoke.js',
  'metadata-manual-fast-path-v648-smoke.mjs',
  'library-durable-invalidation-v648-smoke.js',
  'library-request-boundary-v648-smoke.js',
  'v648-audit-runtime-fixes-smoke.mjs'
];
...
console.log(JSON.stringify({ pass:'v648-release-verify-current-coverage-pass', required:required.length }));
