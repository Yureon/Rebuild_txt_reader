...
for (const rel of ['public/index.html', 'public/login.html', 'public/admin/users.html', 'public/fragments/app-shell.html', 'public/fragments/library-shell.html', 'public/fragments/deferred-ui.html']) {
  const html = read(rel);
