...
assert.ok(library.includes('id="boot-skeleton"') && site.includes('id="boot-skeleton"') && mobile.includes('id="boot-skeleton"'), 'boot skeleton missing from entry pages');
assert.ok(shell.includes('class="library-skeleton"'), 'library skeleton missing from app shell');
assert.ok(site.includes('reader-skeleton-paper') && mobile.includes('reader-skeleton-paper'), 'current reader loading skeleton missing from reader entry pages');
assert.ok(!library.includes('reader-skeleton-paper'), 'library entry must not render a Reader skeleton');
