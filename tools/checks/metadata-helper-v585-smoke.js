...
assert(popupCss.includes('width: 360px') && popupCss.includes('min-width: 260px') && popupCss.includes('@media (max-width: 300px)'));
...
(async () => {
  ...
  console.log(JSON.stringify({ pass:'v585-metadata-helper-redirect-smoke-pass', flows:['naver-direct-login','kakao-age-gate-login','auth-url-recovery'] }));
