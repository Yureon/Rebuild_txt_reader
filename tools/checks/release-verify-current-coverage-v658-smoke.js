...
const required = [
  'release-verify-current-coverage-v658-smoke.js',
  'v658-settings-gesture-labels-smoke.mjs',
  'v657-admin-settings-viewport-smoke.mjs',
  'v656-mobile-explorer-settings-smoke.mjs',
  'settings-workspace-v652-smoke.mjs',
  'settings-library-tab-visibility-v653-smoke.mjs',
  'library-reader-settings-v650-smoke.mjs'
];
...
console.log(JSON.stringify({ pass:'v658-release-verify-current-coverage-pass', required:required.length }));
