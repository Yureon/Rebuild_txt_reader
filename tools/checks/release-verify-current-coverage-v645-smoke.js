...
const required = [
  'release-verify-current-coverage-v645-smoke.js',
  'library-reader-ui-v645-smoke.js',
  'network-search-mode-v645-smoke.js',
  'deferred-ui-style-recovery-v645-smoke.js'
];
...
console.log(JSON.stringify({ pass:'v645-release-verify-current-coverage-pass', required:required.length }));
