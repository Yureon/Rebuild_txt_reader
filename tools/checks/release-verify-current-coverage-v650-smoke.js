...
const required = [
  'release-verify-current-coverage-v650-smoke.js',
  'library-reader-settings-v650-smoke.mjs',
  'reader-fullscreen-header-v650-smoke.mjs'
];
...
console.log(JSON.stringify({ pass:'v650-release-verify-current-coverage-pass', required:required.length }));
