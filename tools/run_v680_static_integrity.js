...
const staticOutput = path.join(root, 'v680_full_tree_static_scan.json');
const integrityOutput = path.join(root, 'v680_static_integrity_results.json');
...
const staticPayload = {
  pass:'v680-full-tree-static-pattern-scan-pass',
...
const payload = {
  schemaVersion:1,
  pass:'v680-static-integrity-pass',
  version:680,
  packageVersion:'6.80.0',
  buildId:'rebuild-v680',
  generatedAt:new Date().toISOString(),
  javascriptSyntax:{
    pass:'v680-javascript-syntax-pass',
