...
const staticOutput = path.join(root, 'v681_full_tree_static_scan.json');
const integrityOutput = path.join(root, 'v681_static_integrity_results.json');
...
const staticPayload = {
  pass:'v681-full-tree-static-pattern-scan-pass',
...
const payload = {
  schemaVersion:1,
  pass:'v681-static-integrity-pass',
  version:681,
  packageVersion:'6.81.0',
  buildId:'rebuild-v681',
  generatedAt:new Date().toISOString(),
  javascriptSyntax:{
    pass:'v681-javascript-syntax-pass',
