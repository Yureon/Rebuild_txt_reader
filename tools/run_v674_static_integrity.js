...
const staticOutput = path.join(root, 'v674_full_tree_static_scan.json');
const integrityOutput = path.join(root, 'v674_static_integrity_results.json');
...
const staticPayload = {
  pass:'v674-full-tree-static-pattern-scan-pass',
...
const payload = {
  schemaVersion:1,
  pass:'v674-static-integrity-pass',
  version:674,
  packageVersion:'6.74.0',
  buildId:'rebuild-v674',
  generatedAt:new Date().toISOString(),
  javascriptSyntax:{
    pass:'v674-javascript-syntax-pass',
