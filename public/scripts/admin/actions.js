(function(global){
  ...
  var PASS = 'v588-admin-user-actions-metadata-access-permission-pass';
  ...
  function appPermissionsPayload(ctx, prefix){ var $ = ctx.$; var fullSearch = $(prefix + '-full-search'); var metadataAccess = $(prefix + '-metadata-access'); return { fullSearch: !fullSearch || fullSearch.checked !== false, metadataAccess: !!(metadataAccess && metadataAccess.checked === true) }; }
