...
export function normalizeFunctionalPrefs(p) {
  ...
  p.libraryDndHoverOpenDelay = 650;
  ...
  p.safeTopInsetExtra = clamp(p.safeTopInsetExtra == null ? 0 : p.safeTopInsetExtra, SAFE_TOP_MIN, SAFE_TOP_MAX);
  p.safeBottomInsetExtra = clamp(p.safeBottomInsetExtra == null ? 0 : p.safeBottomInsetExtra, SAFE_BOTTOM_MIN, SAFE_BOTTOM_MAX);
